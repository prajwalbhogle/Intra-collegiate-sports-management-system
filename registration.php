...
<html>
	...
	<title>Registration &mdash; sspm Sport Events</title>
					...
					<form action="PHP/registration_insert.php" align="center" method="POST">
                      <table width="40%" height="600px" >
						...
						<div class="row form-group">
							<div class="col-md-12">
								<tr>
								<td>Branch And Div:</td>
								<td><input type="text" id="date" name="regdate" class="form-control" placeholder="Your Branch"></td>
							</tr>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<tr>
								<td>Year</td>
								<td><input type="text" id="date" name="address" class="form-control" placeholder="First / Second / Etc. ">
								</td>
							</tr>
							</div>
						</div>
