                      ...
                      <table width="50%" height="300px">
						<div class="row form-group">
							<div class="col-md-12">
								...
								<tr>
								<td>Old Password:</td>
								<td><input type="pass" id="pass" class="form-control" placeholder="Your old password"></td>
							</tr>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<tr>
								<td>New Password:</td>
								<td><input type="pass" id="pass" class="form-control" placeholder="Your New Password "></td>
							</tr>
							</div>
						</div>
						<div class="row form-group">
